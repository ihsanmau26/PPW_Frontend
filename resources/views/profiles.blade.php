                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.photos && data.photos.length > 0) {
                            ...
                            $('#profile-photo').html(
                                `<img src="http://127.0.0.1/tubes-api${photoPath}" alt="Profile Photo" class="d-flex align-items-center justify-content-center rounded-circle bg-secondary text-white" style="width: 100px; height: 100px; font-size: 36px; margin: 0 auto;">`
                            );
                            userHasPhoto = true;
                        } else {
